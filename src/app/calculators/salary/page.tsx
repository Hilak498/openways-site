...
export const metadata: Metadata = {
  ...
  description:
    "מחשבון שכר של Open Ways: מברוטו לנטו לשכירים, לעצמאים, לעובדי משק בית, למקבלי פנסיה מוקדמת ולבעלי הכנסה שלא מעבודה - לפי מדרגות המס ושיעורי הביטוח הלאומי של שנת 2026, לצורך המחשה בלבד.",
        ...
        <div className="container-site relative pt-36 pb-16">
          ...
          <Reveal>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/90">
              מברוטו לנטו: מס הכנסה לפי המדרגות, נקודות זיכוי, דמי ביטוח לאומי
              ובריאות והפקדות לפנסיה. בחרו את סוג המבוטח - שכיר/ה, עצמאי/ת,
              עובד/ת משק בית, פנסיה מוקדמת או הכנסה שלא מעבודה - והשיעורים
              מתעדכנים בהתאם. הנטו הזה הוא גם המספר שהבנק מסתכל עליו כשהוא בוחן
              בקשת משכנתה.
            </p>
          </Reveal>
        </div>
